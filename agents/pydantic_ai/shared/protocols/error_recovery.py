...
class ErrorRecoveryManager:
    ...
    def _attempt_retry_recovery(self, error_context: ErrorContext, 
        ...
        for attempt in range(recovery_action.max_attempts):
            ...
            try:
                ...
                if not recovery_action.should_attempt_recovery(attempt + 1, retry_error):
                    break
        
        return recovery_result
    
    def _attempt_fallback_recovery(self, error_context: ErrorContext,
                                  recovery_action: RecoveryAction,
                                  operation_function: Callable,
                                  *args, **kwargs) -> RecoveryResult:
    ...
    def _attempt_reset_recovery(self, error_context: ErrorContext,
                               recovery_action: RecoveryAction,
                               operation_function: Callable,
                               *args, **kwargs) -> RecoveryResult:
    ...
    def _attempt_custom_recovery(self, error_context: ErrorContext,
                                recovery_action: RecoveryAction,
                                operation_function: Callable,
                                *args, **kwargs) -> RecoveryResult:
    ...
    def _log_recovery_attempt(self, error_context: ErrorContext, recovery_result: RecoveryResult):
    ...
    def get_recovery_statistics(self) -> Dict[str, Any]:
        ...
        successful_recoveries = sum(1 for record in self.recovery_history 
        ...
        return {
            ...
            "avg_recovery_time": sum(record["recovery_result"]["total_recovery_time"] 
                                   for record in self.recovery_history) / total_attempts
        }
