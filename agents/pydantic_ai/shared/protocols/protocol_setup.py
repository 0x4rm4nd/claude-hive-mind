...
def setup_dependencies():
    ...
    dependency_container.register_factory(
        "session_management", create_session_management
    )
...
def create_protocol_with_dependencies(
    ...
    if inject_deps:
        ...
        dependency_mappings = {
            "prompt_generator": {"session_manager": "session_management"},
            "base_protocol": {"session_manager": "session_management"},
            "worker_prompt_protocol": {"session_manager": "session_management"},
        }
