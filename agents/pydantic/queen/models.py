...
class QueenOrchestrationPlan(BaseModel):
    ...
    # Task analysis
    task_analysis: Dict[str, Any] = Field(default_factory=dict, description="Deep analysis of the requested task")
    complexity_assessment: int = Field(ge=1, le=4, description="Overall complexity rating (1-4)")
